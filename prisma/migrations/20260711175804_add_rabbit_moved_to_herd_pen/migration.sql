...
INSERT INTO "new_Rabbit" ("acquiredDate", "acquiredFrom", "breed", "cage", "color", "createdAt", "damId", "dateOfBirth", "doeState", "id", "litterId", "notes", "origin", "photoUrl", "sex", "sireId", "status", "tagId", "updatedAt") SELECT "acquiredDate", "acquiredFrom", "breed", "cage", "color", "createdAt", "damId", "dateOfBirth", "doeState", "id", "litterId", "notes", "origin", "photoUrl", "sex", "sireId", "status", "tagId", "updatedAt" FROM "Rabbit";
DROP TABLE "Rabbit";
