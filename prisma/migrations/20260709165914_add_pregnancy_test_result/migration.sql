...
INSERT INTO "new_Breeding" ("actualKindlingDate", "buckId", "createdAt", "doeId", "expectedKindlingDate", "id", "matingDate", "notes", "outcome", "updatedAt") SELECT "actualKindlingDate", "buckId", "createdAt", "doeId", "expectedKindlingDate", "id", "matingDate", "notes", "outcome", "updatedAt" FROM "Breeding";
DROP TABLE "Breeding";
