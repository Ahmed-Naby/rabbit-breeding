export const ar = {
  ...
  reports: {
    ...
    salesChartRatioNote:
      "الرقم فوق كل شهر هو ناتج قسمة المباع على عدد الأمهات في نفس الشهر، أي «معدل البيع لكل أم» لهذا الشهر وحده. الشهر الذي لا أمهات مسجلة فيه يظهر بلا رقم لأن القسمة غير معرّفة.",
