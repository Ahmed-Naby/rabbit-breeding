export const ar = {
  ...
  reports: {
    ...
    // كُتبت بعد سؤال مربٍّ: لماذا ٥.٩ مفطوم ناقص ٠.٤ نافق لا يساوي المباع؟
    avgFunnelNote:
      "المفطوم لا يذهب كله إلى البيع، فطرح النافق منه لا يعطي المباع: منه ما يُستبقى ليصبح سلالة في المزرعة، ومنه ما لا يزال في رصيد الفطام المتاح للبيع ولم يُبع بعد. كما أن الأرقام الثلاثة لا تُحسب بالطريقة نفسها — المقام مكتوب تحت كل رقم.",
    ...
    avgSalesPerDoeNote:
      "معدل البيع لكل أم يُحسب شهرًا بشهر: مبيعات كل شهر مقسومة على عدد الأمهات الموجودات في المزرعة يوم 1 من نفس الشهر، ثم متوسط هذه النسب. الحساب يبدأ من أول شهر تمت فيه عملية بيع — شهور البداية قبل أول بيعة (شراء وتلقيح وحمل ورضاعة قبل أن يوجد ما يُباع) لا تدخل المتوسط، أما الشهر الذي لا يُباع فيه شيء بعد بدء البيع فيُحتسب صفرًا حقيقيًا. ومتوسط الوزن المباع لكل أم يبدأ من نفس الشهر ليصف الفترة نفسها. المزرعة لا تحفظ تاريخ خروج كل أم، فتُحتسب الأم من تاريخ شرائها أو من أول تلقيح لها حتى آخر تعديل على سجلها إذا لم تعد نشطة.",
    ...
    avgRemainingStockNote:
      "كل أرقام متوسطات الأداء محسوبة على إجمالي أداء المزرعة منذ بداية العمل ولا تتأثر بفلتر الفترة بالأسفل. ورصيد الفطام المتاح للبيع رقم إجمالي وليس متوسطًا، فهو يتغير عند بيع مخزون قديم حتى لو لم يحدث فطام.",
    ...
    salesChartNote:
      "الخط الأصفر عدد الأرانب المباعة في كل شهر ميلادي، والعمود الأزرق عدد الأمهات الموجودات في المزرعة يوم 1 من نفس الشهر — وهو نفس المقام المستخدم في «معدل البيع لكل أم». كل نقطة على الخط شهر مقيس بذاته، وما بين النقطتين خط موصِّل لا قراءة فيه. الشهر الذي لم يُباع فيه شيء ينزل إلى الصفر حتى لا ينضغط المحور الزمني، والشهر الجاري غير معروض لأنه ناقص. لا يتأثر بفلتر الفترة بالأسفل.",
    salesChartBalanceNote:
      "الخط الأخضر هو رصيد الفطام المتاح للبيع في آخر يوم من كل شهر — أي ما تبقّى واقفًا في المزرعة بعد بيع ذلك الشهر. مقيس في آخر الشهر لا في أوله، حتى يكون على نفس الأعمدة التي أخرجته. نزول الخط مع عمود بيع مرتفع معناه أن البيع سبق الفطام، ونزوله مع عمود منخفض معناه نفوق أو احتفاظ بالسلالات.",
    salesChartAxesNote:
      "الثلاثة على مقياس واحد لأن وحدتهم واحدة (رأس أرنب)، فارتفاعهم قابل للمقارنة مباشرة: البيع بالمئات والأمهات بالعشرات، لذلك يظهر العمود الأزرق قصيرًا بطبيعته — وهذا هو الفرق نفسه الذي يقيسه «معدل البيع لكل أم».",
    salesChartRatioNote:
      "الرقم المكتوب فوق العمود الأزرق هو ناتج قسمة المباع على عدد الأمهات في نفس الشهر، أي «معدل البيع لكل أم» لهذا الشهر وحده — وُضع فوق عمود الأمهات لأنه المقام الذي يُقاس عليه. الشهر الذي لا أمهات مسجلة فيه يظهر بلا رقم لأن القسمة غير معرّفة. والرسم يبدأ من أول شهر تمت فيه عملية بيع، وهو نفس الشهر الذي يبدأ عنده «معدل البيع لكل أم» — فمتوسط الأرقام المكتوبة فوق الأعمدة يساوي الرقم الموجود في البطاقة.",
    ...
    herdMonthlyRuleNote:
      "كل رقم هنا متوسط شهري حقيقي: يُقسَم إجمالي كل شهر على عدد الأمهات الواقفات في نفس الشهر، ثم يؤخذ متوسط الشهور. تُحسب الشهور الكاملة داخل الفترة فقط، وتبدأ من أول شهر فيه حركة، فإن لم يكتمل شهر واحد داخل الفترة المختارة ظهرت «—».",
    herdCostNote:
    ...
    herdIdleDescription: (cycleDays: number) =>
      `أمهات مرّ عليها أكثر من ${cycleDays} يومًا (دورة كاملة) دون ولادة. هؤلاء بالتحديد هم سبب انخفاض معدلات «إنتاجية القطيع»، لأن معدلاتها تقسم على كل أم في العنبر سواء أنتجت أو لا.`,
    herdIdleAsOfNote:
      "القائمة محسوبة من تاريخ اليوم، لا من فترة زمنية — الأم إمّا متأخرة عن دورتها الصبح ده أو لا. عدد الأيام يُحسب من آخر ولادة، ومن تاريخ دخولها العنبر لو لم تلد أبدًا.",
