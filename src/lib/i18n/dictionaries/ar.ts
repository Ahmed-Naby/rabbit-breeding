export const ar = {
  ...
  reports: {
    ...
    salesChartNote:
      "عدد الأرانب المباعة في كل شهر ميلادي. الشهر الذي لم يُباع فيه شيء يظهر عمودًا فارغًا حتى لا ينضغط المحور الزمني، والشهر الجاري غير معروض لأنه ناقص. لا يتأثر بفلتر الفترة بالأسفل.",
