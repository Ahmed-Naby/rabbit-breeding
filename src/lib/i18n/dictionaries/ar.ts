export const ar = {
  ...
  reports: {
    ...
    salesChartNote:
      "عدد الأرانب المباعة في كل شهر ميلادي، والعمود الأزرق عدد الأمهات الموجودات في المزرعة يوم 1 من نفس الشهر — وهو نفس المقام المستخدم في «معدل البيع لكل أم». الشهر الذي لم يُباع فيه شيء يظهر عمودًا فارغًا حتى لا ينضغط المحور الزمني، والشهر الجاري غير معروض لأنه ناقص. لا يتأثر بفلتر الفترة بالأسفل.",
    ...
    salesChartAxesNote:
      "العمودان على مقياس واحد، فارتفاعهما قابل للمقارنة مباشرة: البيع بالمئات والأمهات بالعشرات، لذلك يظهر العمود الأزرق قصيرًا بطبيعته — وهذا هو الفرق نفسه الذي يقيسه «معدل البيع لكل أم».",
    salesChartRatioNote:
