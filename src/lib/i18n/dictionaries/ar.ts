export const ar = {
  ...
  reports: {
    ...
    salesChartRatioNote:
      "الرقم فوق كل شهر هو ناتج قسمة المباع على عدد الأمهات في نفس الشهر، أي «معدل البيع لكل أم» لهذا الشهر وحده. الشهر الذي لا أمهات مسجلة فيه يظهر بلا رقم لأن القسمة غير معرّفة. والرسم يبدأ من أول شهر تمت فيه عملية بيع، وهو نفس الشهر الذي يبدأ عنده «معدل البيع لكل أم» — فمتوسط الأرقام المكتوبة فوق النقاط يساوي الرقم الموجود في البطاقة.",
