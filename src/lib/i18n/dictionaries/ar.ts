export const ar = {
  ...
  reports: {
    ...
    avgLifetimeBasis: "إجمالي المزرعة منذ بداية العمل — لا يتأثر بفلتر الفترة",
    ...
    avgRemainingStockNote:
      "رصيد الفطام المتاح للبيع رقم إجمالي وليس متوسطًا: الرصيد التراكمي للمزرعة حتى الآن، ولا يتأثر بفلتر الفترة، فهو يتغير عند بيع مخزون قديم حتى لو لم يحدث فطام.",
