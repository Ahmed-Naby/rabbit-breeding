export const ar = {
  ...
  reports: {
    ...
    avgLifetimeWeaningBasis: (count: number) => `÷ ${count} فطام منذ بداية العمل`,
    ...
    avgRemainingStockNote:
      "متوسط رصيد الفطام المتاح للبيع محسوب على إجمالي أداء المزرعة منذ بداية العمل ولا يتأثر بفلتر الفترة: الرصيد الحالي مقسومًا على كل مرات الفطام، فهو يتغير عند بيع مخزون قديم حتى لو لم يحدث فطام.",
