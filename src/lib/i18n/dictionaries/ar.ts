export const ar = {
   ...
   *
   * Every string here is read by a farmer who believes the write went through,
   * because on his screen it did. So each one has to say what he pressed, and
   * what to do about it, without ever printing a SCREAMING_CODE at him.
   */
  syncRejected: {
    title: "عمليات مرفوضة",
    subtitle:
      "تعديلات ظهرت ناجحة على الجهاز لكن الخادم رفضها، فهي موجودة هنا فقط ولم تصل إلى المزرعة. راجع كل واحدة: إمّا تعيد إرسالها بعد إصلاح سببها، أو تتجاهلها فتُحذف نهائيًا.",
    empty: "لا توجد عمليات مرفوضة — كل ما سجّلته وصل إلى الخادم.",
    badge: (n: number) => (n === 1 ? "عملية مرفوضة" : `${n} عمليات مرفوضة`),
    open: "عرض",
    ...
    dismissConfirm: "سيُحذف هذا التعديل نهائيًا ولن يصل إلى المزرعة. متأكد؟",
    dismissAllConfirm: "سيُحذف كل التعديلات المرفوضة نهائيًا. متأكد؟",
    retryQueued: "أُعيد إرساله — سيُحاول مع المزامنة القادمة",
    unknownReason: "رفض دون سبب مذكور",
    /** The message when the server gave us a code we have no sentence for. */
    rawReason: (code: string) => `رفض الخادم: ${code}`,
    reasons: {
      WEANED_EXCEEDS_BORN_ALIVE: "عدد الفطام أكبر من عدد المواليد الأحياء",
      NO_LITTER: "لا يوجد بطن مسجّل لهذا التلقيح",
      BLANK_REFERENCE: "السطر غير مرتبط بسجل",
      TAG_IN_USE: "رقم الأذن مستخدم بالفعل",
      NO_CURRENT_LITTER: "الأم ليس لديها بطن حالي",
      NO_NURSING_KITS: "لا يوجد مواليد أحياء لتسجيل نافق",
      CAGE_REQUIRED: "لا بد من تحديد العين",
      LITTER_ALREADY_EXISTS: "الولادة مسجّلة لهذا التلقيح بالفعل",
    } as Record<string, string>,
    opTypes: {
      startBreeding: "بدء تلقيح",
      setBreedingOutcome: "نتيجة التلقيح",
      setPregnancyTestResult: "نتيجة الجس",
      markMated: "تسجيل تلقيح",
      confirmPregnant: "تأكيد الحمل",
      confirmPalpation: "تأكيد الجس",
      confirmResorption: "تسجيل امتصاص",
      installNestBox: "نصب العش",
      markKindled: "تسجيل ولادة",
      markWeaned: "تسجيل فطام",
      setLitterCount: "تعديل أعداد البطن",
      setLitterWeaningWeight: "وزن الفطام",
      recordNursingKitDeath: "نفوق نتاج رضيع",
      markMatingFailed: "تلقيح فاشل",
      clearDoeRow: "مسح سطر الأم",
      setMatingDate: "تعديل تاريخ التلقيح",
      recordKindling: "تسجيل ولادة",
      setDoeState: "تغيير حالة الأم",
      setRabbitStatus: "تغيير حالة الأرنب",
      updateRabbitDetails: "تعديل بيانات أرنب",
      createQuickRabbit: "إضافة أرنب",
      finalizeMother: "اعتماد أم جديدة",
      finalizeBuck: "اعتماد ذكر جديد",
      deleteRabbit: "حذف أرنب",
      saveQuickRabbitCage: "تحديد العين",
      saveQuickRabbitWeight: "تسجيل وزن",
      promoteToHerdPen: "ترقية إلى القطيع",
      transferKits: "نقل رضاعة",
      recordKitSale: "بيع نتاج",
      recordWeanedKitDeath: "نفوق نتاج مفطوم",
      recordKitStockAdjustment: "تسوية مخزون",
      deleteKitStockMovement: "حذف حركة مخزون",
      createHealthRecord: "سجل صحي",
      deleteHealthRecord: "حذف سجل صحي",
      createTransaction: "حركة مالية",
      deleteTransaction: "حذف حركة مالية",
      updateRecurringExpenses: "المصروفات الدورية",
      postRecurringExpenses: "ترحيل المصروفات الدورية",
      updateSettings: "تعديل الإعدادات",
      addBreed: "إضافة سلالة",
      deleteBreed: "حذف سلالة",
    } as Record<string, string>,
  },
  auth: {
  ...
  reports: {
    ...
    topNote: (sharePct: number) =>
      `أفضل ${sharePct}٪ من أمهات المزرعة بالدرجة — النصف الذي يُنتخب منه بدائل القطيع. حصة لا عددًا ثابتًا، فأفضل عشرين أمًا في عنبر فيه ثلاثون شيء، وفي عنبر فيه أربعمائة شيء آخر. عند تساوي الدرجة تتقدّم صاحبة الولادات الأكثر، لأن رقمًا وراءه ثماني ولادات أوثق من رقم وراءه ثلاث. لا تدخل الترتيب أم لم يكتمل سجلها: بطن واحد ممتاز يصنع أمًا محظوظة لا أمًا ممتازة.`,
  },
  records: {
    title: "السجلات",
  ...
  breedings: {
    ...
    weanedExceedsBornAlive: "لا يمكن أن يتجاوز المفطوم عدد المواليد الأحياء",
    noLitterForBreeding: "لا يوجد بطن مسجّل لهذا التلقيح — سجّل الولادة أولًا",
    blankReference: "هذا السطر غير مرتبط بسجل — حدّث الصفحة وأعد المحاولة",
