...
function StatCard({
  ...
  return (
    <div className={cn("transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] rounded-xl border bg-card text-card-foreground shadow-xs p-4 flex items-center justify-between", className)}>
      <div>
